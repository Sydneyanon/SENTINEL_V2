...
MIN_CONVICTION_SCORE = 70  # Pre-graduation threshold (40%+ bonding curve) - OPT-001: Testing higher quality bar
POST_GRAD_THRESHOLD = 70   # Post-graduation threshold (100% - on Raydium) - OPT-001: Testing higher quality bar
