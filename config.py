...
MIN_CONVICTION_SCORE = 70  # Pre-graduation threshold (40%+ bonding curve) - LOWERED to catch more signals
POST_GRAD_THRESHOLD = 65   # Post-graduation threshold (100% - on Raydium) - LOWERED to catch more signals
