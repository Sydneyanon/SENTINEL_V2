...
STABLE MODE (2026-01-31): KOL tracking RE-ENABLED
Restoring proven wallet list from before experimental changes.
Jan 22 had 53% WR with this wallet-based approach.
"""
...
# RESTORED from pre-organic-scanner config
KOL_WALLETS = {
