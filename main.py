...
async def lifespan(app: FastAPI):
    ...
    # Automated collectors DISABLED for lean deployment
    # (ralph, automated_collector, automated_daily_collector removed)
    logger.info("📊 Data collectors disabled (lean mode)")
